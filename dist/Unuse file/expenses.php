...
<!-- Mirrored from www.pixelwibes.com/template/my-task/html/dist/expenses.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Jun 2022 12:39:48 GMT -->
<head>
    <meta charset="utf-8">
            ...
            <ul class="menu-list flex-grow-1 mt-3">
                ...
                <li class="collapsed">
                    ...
                    <ul class="sub-menu collapse show" id="menu-Componentsoneone">
                        ...
                        <li><a class="ms-link active" href="expenses.php"><span>Expenses</span> </a></li>
                    </ul>
                </li>
                <li class="collapsed">
