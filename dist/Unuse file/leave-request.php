...
<!-- Mirrored from www.pixelwibes.com/template/my-task/html/dist/leave-request.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Jun 2022 12:39:48 GMT -->
<head>
    <meta charset="utf-8">
            ...
            <ul class="menu-list flex-grow-1 mt-3">
                ...
                <li class="collapsed">
                    ...
                    <ul class="sub-menu collapse show" id="emp-Components">
                        ...
                        <li><a class="ms-link active" href="leave-request.php"> <span>Leave Request</span></a></li>
                            ...
                            <div class="card-body">
                                <table id="myProjectTable" class="table table-hover align-middle mb-0" style="width:100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <a href="employee-profile.php" class="fw-bold text-secondary">#EMP : 00001</a>
                                            </td>
                                           <td>
                                               <img class="avatar rounded-circle" src="assets/images/xs/avatar1.jpg" alt="">
                                        ...
                                        <tr>
                                            <td>
                                                <a href="employee-profile.php" class="fw-bold text-secondary">#EMP : 00038</a>
                                            </td>
                                            <td>
                                                <img class="avatar rounded-circle" src="assets/images/xs/avatar2.jpg" alt="">
                                         ...
                                         <tr>
                                            <td>
                                                <a href="employee-profile.php" class="fw-bold text-secondary">#EMP : 00007</a>
                                            </td>
                                            <td>
                                                <img class="avatar rounded-circle" src="assets/images/xs/avatar3.jpg" alt="">
                                         ...
                                         <tr>
                                            <td>
                                                <a href="employee-profile.php" class="fw-bold text-secondary">#EMP : 00010</a>
                                            </td>
                                            <td>
                                                <img class="avatar rounded-circle" src="assets/images/xs/avatar4.jpg" alt="">
                                         ...
                                         <tr>
                                            <td>
                                                <a href="employee-profile.php" class="fw-bold text-secondary">#EMP : 00002</a>
                                            </td>
                                            <td>
                                                <img class="avatar rounded-circle" src="assets/images/xs/avatar5.jpg" alt="">
                                         ...
                                         <tr>
                                            <td>
                                                <a href="employee-profile.php" class="fw-bold text-secondary">#EMP : 00005</a>
                                            </td>
                                            <td>
                                                <img class="avatar rounded-circle" src="assets/images/xs/avatar6.jpg" alt="">
                                         ...
                                         <tr>
                                            <td>
                                                <a href="employee-profile.php" class="fw-bold text-secondary">#EMP : 00014</a>
                                            </td>
                                            <td>
                                                <img class="avatar rounded-circle" src="assets/images/xs/avatar7.jpg" alt="">
