...
<html class="no-js" lang="en" dir="ltr">
    ...
    <!-- Mirrored from www.pixelwibes.com/template/my-task/html/dist/employee-profile.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Jun 2022 12:39:48 GMT -->
    <head>
        <meta charset="utf-8">
                    ...
                    <div class="container-xxl">
                        ...
                        <div class="row g-3">
                            <div class="col-xl-8 col-lg-12 col-md-12">
                                    ...
                                    <div class="card-body  d-flex teacher-fulldeatil">
                                        <div class="profile-teacher pe-xl-4 pe-md-2 pe-sm-4 pe-0 text-center w220 mx-sm-0 mx-auto">
                                            ...
                                            <div class="about-info d-flex align-items-center mt-3 justify-content-center flex-column">
                                                <h6 class="mb-0 fw-bold d-block fs-6"><?php echo $row['Name'] ?></h6>
                                                <span class="text-muted small">Employee Id : <?php echo $row['ID'] ?></span>
                                            </div>
                                        </div>
                                        <div class="teacher-info border-start ps-xl-4 ps-md-3 ps-sm-4 ps-4 w-100">
                                            <h6  class="mb-0 mt-2  fw-bold d-block fs-6"><?php echo $row['Name'] ?></h6>
                                            ...
                                            <div class="row g-2 pt-2">
                                                <div class="col-xl-5">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <span class="ms-2 small"><?php echo $row['ContactNo'] ?></span>
                                                    </div>
                                                </div>
                                                <div class="col-xl-5">
                                                    <div class="d-flex align-items-center">
                                                        <i class="icofont-email"></i>
                                                        <span class="ms-2 small"><?php echo $row['Email'] ?></span>
                                                    </div>
                                                </div>
                                                <div class="col-xl-5">
                                                    <div class="d-flex align-items-center">
                                                        <i class="icofont-birthday-cake"></i>
                                                        <span class="ms-2 small"><?php echo $row['Doj'] ?></span>
                                                    </div>
                                                </div>
                                                <div class="col-xl-5">
                                                    <div class="d-flex align-items-center">
                                                        <i class="icofont-address-book"></i>
                                                        <span class="ms-2 small"><?php echo $row['Address'] ?></span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <h6 class="fw-bold  py-3 mb-3">Informations</h6>
                                            ...
                                            <div class="card-body">
                                                <ul class="list-unstyled mb-0">
                                                    ...
                                                    <li class="row flex-wrap mb-3">
                                                        ...
                                                        <div class="col-6">
                                                            <span class="text-muted"><?php $gender = $row['Gender'];
if ($gender == "m") {
    echo "Male";
} else {
    echo "Female";
                                                    ...
                                                    <li class="row flex-wrap mb-3">
                                                        <div class="col-6"> 
                                                            <span class="fw-bold">Doj</span>
                                                        </div>
                                                        <div class="col-6">
                                                            <span class="text-muted"><?php echo $row['Doj'] ?></span>
                                                        </div>
                                                    </li>
                                                    ...
                                                    <li class="row flex-wrap">
                                                        ...
                                                        <div class="col-6">
                                                            <span class="text-muted"><?php echo $row['ContactNo'] ?></span>
                                                        </div>
                                                    </li>
                                                </ul>
                                            </div>
                                    ...
                                    <form action="updateProfile.php" method="post">
                                        <div class="row g-3 mb-3">
                                            <div class="col">
                                                ...
                                                <input type="text" name="name" class="form-control" id="exampleFormControlInput877" value="<?php echo $row['Name'] ?>"> 
                                            </div>
                                            <div class="col">
                                                <label for="exampleFormControlInput977" class="form-label">Email</label>
                                                <input type="text" name="email" class="form-control" id="exampleFormControlInput977" value="<?php echo $row['Email'] ?>"> 
                                            </div>
                                        </div>
                                        <div class="row g-3 mb-3">
                                                <div class="col-6">
                                                    <label for="exampleFormControlInput4777" class="form-label">Contact Number</label>
                                                    <input type="text" name="contact" class="form-control" id="exampleFormControlInput4777" value="<?php echo $row['ContactNo'] ?>">
                                                </div>

                                            <div class="col">
                                                <label for="exampleFormControlInput2770" class="form-label">Doj</label>
                                                <input disabled="true" type="text" class="form-control" id="exampleFormControlInput2770" value="<?php echo $row['Doj'] ?>">
                                            </div>
                                        </div> 
                                        <div class="row g-3 mb-3">
                                            <div class="col-6">
                                                <label for="exampleFormControlInput4777" class="form-label">Address</label>
                                                <input type="text" name="add" class="form-control" id="exampleFormControlInput4777" value="<?php echo $row['Address'] ?>">
                                            </div>
                                            <div class="col">
                                                <label for="exampleFormControlInput2770" class="form-label">Password</label>
                                                <input type="text" name="pass" class="form-control" id="exampleFormControlInput2770" value="<?php echo $row['password'] ?>">
                                            </div>
