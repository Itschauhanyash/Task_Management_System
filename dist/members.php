...
<!-- Mirrored from www.pixelwibes.com/template/my-task/html/dist/members.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Jun 2022 12:39:48 GMT -->
<head>
    <meta charset="utf-8">
                        ...
                        <div class="card teacher-card">
                            <div class="card-body d-flex">
                                ...
                                <div class="teacher-info border-start ps-xl-4 ps-md-3 ps-sm-4 ps-4 w-100">
                                    ...
                                    <a href="task.php" class="btn btn-dark btn-sm mt-1"><i class="icofont-plus-circle me-2 fs-6"></i>Add Task</a>
                                    <a href="employee-profile.php" class="btn btn-dark btn-sm mt-1"><i class="icofont-invisible me-2 fs-6"></i>Profile</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card teacher-card">
                            <div class="card-body d-flex">
                                ...
                                <div class="teacher-info border-start ps-xl-4 ps-md-3 ps-sm-4 ps-4 w-100">
                                    ...
                                    <a href="task.php" class="btn btn-dark btn-sm mt-1"><i class="icofont-plus-circle me-2 fs-6"></i>First Task</a>
                                    <a href="employee-profile.php" class="btn btn-dark btn-sm mt-1"><i class="icofont-invisible me-2 fs-6"></i>Profile</a>
                                </div>
                            </div>
                        </div>
