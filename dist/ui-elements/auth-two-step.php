...
<!-- Mirrored from www.pixelwibes.com/template/my-task/html/dist/ui-elements/auth-two-step.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Jun 2022 12:40:05 GMT -->
<head>
    <meta charset="utf-8">
                        ...
                        <div class="w-100 p-3 p-md-5 card border-0 bg-dark text-light" style="max-width: 32rem;">
                            ...
                            <form class="row g-1 p-3 p-md-4">
                                ...
                                <div class="col-12 text-center mt-4">
                                    <a href="index.php" title="" class="btn btn-lg btn-block btn-light lift text-uppercase">Verify my account</a>
                                </div>
                                <div class="col-12 text-center mt-4">
