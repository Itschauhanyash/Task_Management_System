...
<!-- Mirrored from www.pixelwibes.com/template/my-task/html/dist/ui-elements/changelog.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Jun 2022 12:40:09 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <div class="sidebar px-4 py-4 py-md-5 me-0">
        <div class="d-flex flex-column h-100">
            ...
            <ul class="menu-list flex-grow-1 mt-3">
                ...
                <li><a class="m-link active" href="changelog.php"><i class="icofont-edit"></i> <span>Changelog</span> <span
