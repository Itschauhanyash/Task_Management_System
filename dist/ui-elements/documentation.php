...
<!-- Mirrored from www.pixelwibes.com/template/my-task/html/dist/ui-elements/documentation.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Jun 2022 12:40:08 GMT -->
<head>
    <meta charset="utf-8">
   ...
   <div class="sidebar px-4 py-4 py-md-5 me-0">
    <div class="d-flex flex-column h-100">
        ...
        <ul class="menu-list flex-grow-1 mt-3">
            ...
            <li><a class="m-link active" href="documentation.php"><i class="icofont-law-document"></i>
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                        ...
                        <a href="../index-2.php" title="" class="btn btn-dark lift">Go to Dashboard</a>
                    </div>
                </div>
                        ...
                        <div class="mb-3 pt-3 card">
                            ...
                            <div class="card-body">
                                ...
                                <ol style="line-height: 30px;">
                                    ...
                                    <li><strong>Note:</strong> However, any SASS code you write must be able compile via Grunt as well.It will generate pre-compiled javascript templates. Reads all the *.php files from `assets/js/filename` and outputs `assets/js/filename.templates.js`. Template.js will contains code of UI design and will be change each time you build solution through above command.</li>
                                </ol>
                                    ...
                                    <li>
                                        ...
                                        <ul class="mb-3">
                                            ...
                                            <li>
                                                ...
                                                <ul class="mb-3">
                                                    <li><strong><i class="icofont-file-code color-light-orange me-2"></i>Index.php</strong> <span class="text-muted">- All Html file like Authentication,UI Components,Changelog etc... </span></li>
                                                </ul>
                                            </li>
                                            <li>
                                                <strong><i class="icofont-file-code color-light-orange  me-2"></i>Index.php</strong><span class="text-muted">- my-Task Html Template</span>
                                            </li>
                                        </ul>
                                    </li>
                                    <li>
                                        ...
                                        <ul class="mb-3">
                                            ...
                                            <li><strong><i class="icofont-file-code color-light-orange me-2"></i>index.php</strong> <span class="text-muted">- well project document</span></li>
                                        </ul>
                                    </li>
                                    <li>
