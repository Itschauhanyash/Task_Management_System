...
<!-- Mirrored from www.pixelwibes.com/template/my-task/html/dist/team-leader.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Jun 2022 12:39:47 GMT -->
<head>
    <meta charset="utf-8">
                                ...
                                <table id="myProjectTable" class="table table-hover align-middle mb-0" style="width:100%">
                                    ...
                                    <tbody>
                                        <tr>
                                           ...
                                           <td>
                                               <a href="projects.php">Box of Crayons</a>
                                           </td>
                                           <td>
                                                <a href="task.php">5 Task</a>
                                           </td>
                                           <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="projects.php">Fast Cad</a>
                                            </td>
                                            <td>
                                                 <a href="task.php">8 Task</a>
                                            </td>
                                            <td>
                                         ...
                                         <tr>
                                            ...
                                            <td>
                                                <a href="projects.php">Gob Geeklords</a>
                                            </td>
                                            <td>
                                                 <a href="task.php">2 Task</a>
                                            </td>
                                            <td>
                                         ...
                                         <tr>
                                            ...
                                            <td>
                                                <a href="projects.php">Java Dalia</a>
                                            </td>
                                            <td>
                                                 <a href="task.php">7 Task</a>
                                            </td>
                                            <td>
                                         ...
                                         <tr>
                                            ...
                                            <td>
                                                <a href="projects.php">Practice to Perfect</a>
                                            </td>
                                            <td>
                                                 <a href="task.php">9 Task</a>
                                            </td>
                                            <td>
                                         ...
                                         <tr>
                                            ...
                                            <td>
                                                <a href="projects.php">Rhinestone</a>
                                            </td>
                                            <td>
                                                 <a href="task.php">5 Task</a>
                                            </td>
                                         ...
                                         <tr>
                                            ...
                                            <td>
                                                <a href="projects.php">Social Geek Made</a>
                                            </td>
                                            <td>
                                                 <a href="task.php">15 Task</a>
                                            </td>
                                            <td>
